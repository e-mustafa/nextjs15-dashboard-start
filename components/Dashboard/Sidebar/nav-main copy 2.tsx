...
import { ChevronRight, FolderIcon, ForwardIcon, MoreHorizontalIcon, Trash2Icon, type LucideIcon } from 'lucide-react';
			...
			<SidebarMenu>
				{items.map((item, index) => (
					<>
						...
						// 		(
						// 	<DropdownMenu key={item.title[locale] + index}>
