				...
				<FormItem className={fieldConfig.class}>
					...
					<div className='relative'>
						...
						{fieldConfig.IconStart && (
							<div className='absolute top-1/2 -translate-y-1/2 start-2 w-6 h-auto text-muted-foreground [&_svg]:size-5 text-sm text-center'>
								{typeof fieldConfig.IconStart === 'string' ? t(fieldConfig.IconStart) : <fieldConfig.IconStart />}
							</div>
						)}

						{fieldConfig.IconEnd && (
							<div className='absolute top-1/2 -translate-y-1/2 end-2 w-7 text-muted-foreground [&_svg]:size-5 text-sm text-center'>
